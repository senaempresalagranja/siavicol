                ...
                <div class="formulario formulario_mediano">
                   ...
                   <div class="col-xs-12 col-md-6">
                     <div class="form-group">
                       ...
                       <input type="button" class="form-control" name="FechaInicio" id="Fecha_Inicio">
 					 </div>   
				   </div>	
        			   ...
        			   <div class="modal-content">
                         ...
                         <div class="modal-body">
    					   <label class="form-control-label" for="fecha_produccion_select">Selecciona El Galpón</label>
						     ...
						     <input type="text" class="form-control" name="" id="fecha_inicio_consulta" placeholder="DD/MM/AAAA">
						     <script>
