...
<head>
	...
	<title>Consultar Encasetamiento</title>
          ...
          <div class="block block-40 ">
            <a href="#" id="trigger" class="menu-trigger icon_m icon-reorder-option"></a>
              <div class="banner_contenido">
                ...
                <h1 class="banner_h1">Consultar Encasetamiento</h1>
              </div>
          </div>
		    ...
		    <div class="container">				
              <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tr>
                    ...
                    <th>Fecha Inicio</th>
                    <th>Fecha Fin</th>
                    <th>Cantidad Inicial de Animales</th>
...
if ($fila1>0) {
	...
	$fila[7]=round(($fila[7]/7)+$fila[6]);
		  ...
		  <div class="box">
			<a class="button button--Registrar" href="../Registrar/Reg_Encasetamiento.php" ><i class="button__icons icon_b icon-reply-arrow"></i><span>Guardar</span></a>

			<a class="button button--Excel" target="_blank" href="../Exportar/Exportar_Excel/Expor-Excel_Encasetamiento.php"><i class="button__icons icon_b icon-xls"></i><span>Exportar Excel</span></a>
					
			<a class="button button--PDF" target="_blank" href="../Exportar/Exportar_PDF/Expor-PDF_Encasetamiento.php"><i class="button__icons icon_b icon-pdf"></i><span>Exportar PDF</span></a>
