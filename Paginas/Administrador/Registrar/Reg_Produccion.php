                ...
                <div class="formulario">
				  ...
				  <div class="col-xs-12 col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="Fecha" id="fecha_produccion">
					</div>
                  </div>
...
function inicio() {
    ...
    $("#fecha_produccion").keyup(validar_fecha_produccion)
    // ---------------------------------------------------------------------------------------
    var hoy = new Date();
    var dd = hoy.getDate();
...
function enviar() {
    if (validar_encasetamiento() == true && validar_responsable() == true && validar_no_comerciales() == true && validar_huevosA() == true && validar_huevosAA() == true && validar_huevosAAA() == true && validar_huevosB() == true && validar_huevosC() == true && validar_huevos_jumbo() == true && validar_fecha_produccion() == true) {
        validar_huevos_comerciales();
        var encasetamiento = document.getElementById("encasetamiento").value;
        var responsable = document.getElementById("responsable").value;
        var fecha_produccion = document.getElementById("fecha_produccion").value;
...
function validar_fecha_produccion() {
	var fecha_produccion = document.getElementById("fecha_produccion").value;
	var hoy = new Date();
	var dd = hoy.getDate();
    var mm = hoy.getMonth() + 1; //hoy es 0!
    ...
    if (fecha_produccion < hoy) {
        var fecha_produccion = document.getElementById("fecha_produccion").style.border = "2px solid red";
        return false;
    } else if (fecha_produccion == "Invalid Date") {
        var fecha_produccion = document.getElementById("fecha_produccion").style.border = "2px solid red";
    } else {
        var fecha_produccion = document.getElementById("fecha_produccion").style.border = "2px solid #4caf50";
        return true;
    }
}
