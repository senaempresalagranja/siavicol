...
<head>
	...
	<title>Registrar Marcas De Articulos</title>
          ...
          <div class="block block-40 ">
            <a href="#" id="trigger" class="menu-trigger icon_m icon-reorder-option"></a>
              <div class="banner_contenido">
                ...
                <h1 class="banner_h1">Registrar Marcas De Artículos</h1>
              </div>
          </div>
                ...
                <div class="formulario">
                     ...
                     <div class="col-xs-12 col-lg-6 ">				
	            	     ...
	            	     <tbody>
				  			<?php 
								...
								$busqueda="SELECT * FROM marcas ORDER BY Nombre DESC";
                  ...
                  <div class="modal fade" id="buscar_galpon" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        			  ...
        			  <div class="modal-content">
            			  ...
            			  <h3 class="header_buscar-titulo">Buscar Marcas</h3>
          				</div>
          				<div class="modal-body">   
		    			  <select name="" id="marcas" onclick='consultar_galpon()' class="form-control">
...
function actualizar_Marcas() {
    if (validar_marca() == true) {
        ...
        //Registrar en mayusculas
        Marca = Marca.toUpperCase();
        $("#resultado").load("Actualizar/Actu_Marca.php", {
            marcas: marcas,
            Marca: Marca
        });
    } else {
...
function nuevo_registro() {
    var Marca = document.getElementById("Marca").value = "";
    var Marca = document.getElementById("Marca").focus();
}

function consultar_galpon() {
    var marcas = document.getElementById("marcas").value;
    $("#resultado").load("Cons_Registro/Cons-Registro_Marcas.php", {
        marcas: marcas
    })
}
