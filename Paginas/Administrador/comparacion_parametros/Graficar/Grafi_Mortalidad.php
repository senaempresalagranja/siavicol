...
$(function () {
  ...
  $('#container').highcharts({
    ...
    title: {
      text: 'Mortalidad de Encasetamiento ' + nombre_encasetamiento
    },
    subtitle: {
      text: 'SIAVICOL'
    },
    ...
    tooltip: {
      headerFormat: '<span style="font-size:10px">{point.key}</span><table>',
        ...
        series: [{
          ...
          $connection=mysqli_connect("localhost","root","","siavicol");
          $sql = "SELECT  week(`Fecha`) as semana, SUM(NumeroAves) as NumeroAves FROM `mortalidad` where idEncasetamiento=$id_encasetamiento  GROUP BY semana";
          $result = mysqli_query($connection,$sql);
