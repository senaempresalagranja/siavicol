<?php
	...
	if($resultado->num_rows > 0 ){
		...
		$objPHPExcel->getProperties()->setCreator("Siavicol") //Autor
							 ...
							 ->setTitle("Registros De Alimentacion")
							 ->setSubject("Registros De Alimentacion")
							 ->setDescription("Registros De Alimentacion de la unidad de avicultura")
							 ->setKeywords("Registros De Alimentacion")
		...
		$tituloReporte = "Registros De Alimentacion";
		$titulosColumnas = array('Encasetamiento', 'Articulo', 'Cantidad', 'Fecha ', 'Hora');
      ...
      //   			'wrap'          => true 
		...
		$objPHPExcel->getActiveSheet()->setTitle('Registros De Alimentacion');
		...
		header('Content-Disposition: attachment;filename="Alimentacion_Registrada (SIAVICOL).xlsx"');
