<?php
	...
	if($resultado->num_rows > 0 ){
		...
		$objPHPExcel->getProperties()->setCreator("Siavicol") //Autor
							 ...
							 ->setTitle("Marcas Registradas")
							 ->setSubject("Marcas Registradda")
							 ->setDescription("Marcas de la unidad de avicultura")
							 ->setKeywords("Marcas")
		...
		$tituloReporte = "Marcas Registradas";
		...
		$objPHPExcel->getActiveSheet()->setTitle('Marcas Registradas');
		...
		header('Content-Disposition: attachment;filename="Marcas_Registradas-SIAVICOL.xlsx"');
