<?php
	...
	$consulta = "SELECT * FROM galpon  ORDER BY  NombreGalpon";
	...
	if($resultado->num_rows > 0 ){
		...
		$objPHPExcel->getProperties()->setCreator("Siavicol") //Autor
							 ...
							 ->setTitle("Galpones Registrados")
							 ->setSubject("Galpones Registrados")
							 ->setDescription("Galpones de la unidad de avicultura")
							 ->setKeywords("Galpones")
		...
		$tituloReporte = "Galpones Registrados";
		$titulosColumnas = array('Nombre del Galpon', 'Extension Galpon', 'Cantidad Animales', 'estado');
...
$fila[4]="Disponible";
      ...
      //   			'wrap'          => true 
		...
		$objPHPExcel->getActiveSheet()->setTitle('Galpones Registrados');
		...
		header('Content-Disposition: attachment;filename="Galpones_Registrados-SIAVICOL.xlsx"');
