...
<head>
	...
	<title>Comparar Produccion</title>
  ...
  <div class="container-s">
          ...
          <div class="block block-40 ">
            <a href="#" id="trigger" class="menu-trigger icon_m icon-reorder-option"></a>
              <div class="banner_contenido">
                ...
                <h1 class="banner_h1">Comparar Producción</h1>
              </div>
          </div>
            ...
            <div class="row">
              <div class="col-xs-12 col-md-3">
		  	  ...
		  	  <button type="button" title="Graficar" class="button button--Graficar" value="graficar produccion" onclick="graficar()"><i class="button__icon icon_b icon-area-chart"></i><span>Graficar</span></button>
		 		<!-- <input type="button" value="graficar produccion" onclick="graficar()"> -->
	...
	<script type="text/javascript">
	  ...
	  function mostrar_semanas() {
	  	...
	  	$("#contenedor_semanas").load("Mostrar_Semanas/mostrar_semanas.php",{id_encasetamiento:id_encasetamiento})
	  ...
	  $("#container").load("Graficar/Grafi_Produccion.php",{id_encasetamiento:id_encasetamiento,semanas:semanas});
		
		  }else{

	  $("#container").load("Graficar_Filtro/graficar_filtro.php",{id_encasetamiento:id_encasetamiento,semanas:semanas});
