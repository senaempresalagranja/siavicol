...
<head>
	...
	<title>Consultar Alimentacion</title>
        ...
        <div class="scroller-inner">
         <!-- Top Navigation -->
          ...
          <div class="block block-40 ">
            <a href="#" id="trigger" class="menu-trigger icon_m icon-reorder-option"></a>
              <div class="banner_contenido">
                ...
                <h1 class="banner_h1">Consultar Alimentación</h1>
              </div>
          </div>
          ...
          <div class="box">
			...
			<a class="button button--Excel" target="_blank" href="../Exportar/Exportar_Excel/Expor-Excel_Alimentacion.php"><i class="button__icons icon_b icon-xls"></i><span>Exportar Excel</span></a>
					
			<a class="button button--PDF" target="_blank" href="../Exportar/Exportar_PDF/Expor-PDF_Alimentacion.php"><i class="button__icons icon_b icon-pdf"></i><span>Exportar PDF</span></a>
