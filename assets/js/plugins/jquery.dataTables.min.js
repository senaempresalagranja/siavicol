...
b.asDestroyStripes.length)&&f.children().each(function(a){h(this).addClass(b.asDestroyStripes[a%p])}));c=h.inArray(b,m.settings);-1!==c&&m.settings.splice(c,1)})});h.each(["column","row","cell"],function(a,b){p(b+"s().every()",function(a){var d=this.selector.opts,e=this;return this.iterator(b,function(f,g,h,i,m){a.call(e[b](g,"cell"===b?h:d,"cell"===b?d:k),g,h,i,m)})})});p("i18n()",function(a,b,c){var d=this.context[0],a=Q(a)(d.oLanguage);a===k&&(a=b);c!==k&&h.isPlainObject(a)&&(a=a[c]!==k?a[c]:a._);
	...
	// estos scrips son para cambiar el bombre de algunos titulos de el data table y para agregar numero al filtro 
...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"Proximo",sPrevious:"Anterior"},sEmptyTable:"No Hay Datos Disponibles En La Tabla",sInfo:"Proyectar _START_ A _END_ De _TOTAL_ Registros",sInfoEmpty:"Proyectar 0 A 0 De 0 Registros",sInfoFiltered:"(Filtrados Desde _MAX_ Registros En Total)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ Registros",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Este Registro No Existe O Esta Mal Escrito"},oSearch:h.extend({},
